...
val CardContent = Color(0xFFD3EEFF)
val Gray = Color(0xFFDBDBDB)
val Safe = Color(0xFF71E986)
val Warn = Color(0xFFE9AD5E)
val Error = Color(0xFFEB537B)
val Cancel = Color(0xFF858585)
val Peace = Color(0xFF269DCE)
...
val customColor1Light = Color(0xFF226488)
val onCustomColor1Light = Color(0xFFFFFFFF)
val customColor1ContainerLight = Color(0xFFC7E7FF)
val onCustomColor1ContainerLight = Color(0xFF001E2E)
val customColor2Light = Color(0xFF1C6B50)
val onCustomColor2Light = Color(0xFFFFFFFF)
val customColor2ContainerLight = Color(0xFFA6F2D1)
val onCustomColor2ContainerLight = Color(0xFF002116)

val customColor1LightMediumContrast = Color(0xFF004866)
val onCustomColor1LightMediumContrast = Color(0xFFFFFFFF)
val customColor1ContainerLightMediumContrast = Color(0xFF3D7B9F)
val onCustomColor1ContainerLightMediumContrast = Color(0xFFFFFFFF)
val customColor2LightMediumContrast = Color(0xFF004D37)
val onCustomColor2LightMediumContrast = Color(0xFFFFFFFF)
val customColor2ContainerLightMediumContrast = Color(0xFF378166)
val onCustomColor2ContainerLightMediumContrast = Color(0xFFFFFFFF)

val customColor1LightHighContrast = Color(0xFF002537)
val onCustomColor1LightHighContrast = Color(0xFFFFFFFF)
val customColor1ContainerLightHighContrast = Color(0xFF004866)
val onCustomColor1ContainerLightHighContrast = Color(0xFFFFFFFF)
val customColor2LightHighContrast = Color(0xFF00281B)
val onCustomColor2LightHighContrast = Color(0xFFFFFFFF)
val customColor2ContainerLightHighContrast = Color(0xFF004D37)
val onCustomColor2ContainerLightHighContrast = Color(0xFFFFFFFF)

val customColor1Dark = Color(0xFF92CDF6)
val onCustomColor1Dark = Color(0xFF00344C)
val customColor1ContainerDark = Color(0xFF004C6C)
val onCustomColor1ContainerDark = Color(0xFFC7E7FF)
val customColor2Dark = Color(0xFF8BD6B5)
val onCustomColor2Dark = Color(0xFF003828)
val customColor2ContainerDark = Color(0xFF00513B)
val onCustomColor2ContainerDark = Color(0xFFA6F2D1)

val customColor1DarkMediumContrast = Color(0xFF97D2FA)
val onCustomColor1DarkMediumContrast = Color(0xFF001826)
val customColor1ContainerDarkMediumContrast = Color(0xFF5C97BD)
val onCustomColor1ContainerDarkMediumContrast = Color(0xFF000000)
val customColor2DarkMediumContrast = Color(0xFF8FDABA)
val onCustomColor2DarkMediumContrast = Color(0xFF001B11)
val customColor2ContainerDarkMediumContrast = Color(0xFF559E81)
val onCustomColor2ContainerDarkMediumContrast = Color(0xFF000000)

val customColor1DarkHighContrast = Color(0xFFF8FBFF)
val onCustomColor1DarkHighContrast = Color(0xFF000000)
val customColor1ContainerDarkHighContrast = Color(0xFF97D2FA)
val onCustomColor1ContainerDarkHighContrast = Color(0xFF000000)
val customColor2DarkHighContrast = Color(0xFFEDFFF4)
val onCustomColor2DarkHighContrast = Color(0xFF000000)
val customColor2ContainerDarkHighContrast = Color(0xFF8FDABA)
