...
#保留所有网络接口及其方法
-keep interface com.example.wanandroidcompose.network.ApiService { *; }
#保留实体类
-keep class com.example.wanandroidcompose.data.entity.** { *; }
-keep class com.example.wanandroidcompose.network.BaseRespModel { *; }
-keep class com.example.wanandroidcompose.network.SuperBaseModel { *; }
