...
//            logd(
//                "getResult:${if (response.isSuccessful) "Success" else "Fail"}",
//                "code:${response.code()}",
            ...
            if (response.isSuccessful) {
                ...
                if (body != null) {
                    if (body.errorCode == 0) {
                        ...
                        emit(MyResult.failure(body.errorCode, body.errorMessage, body.data))
                    }
                }else{
...
//        logd(
//            "getResultT",
//            "getResultT:${if (response.isSuccessful) "Success" else "Fail"}"+
//            "code:${response.code()}"+
//            "msg:${response.message()}"+
//            "url:${response.raw().request.url}"
//        )
